namespace MoviesGallery.Services.Controllers
{
    ...
    using MoviesGallery.Services.Models;
    using MoviesGallery.Services.Providers;
    using MoviesGallery.Services.Results;
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var user = new ApplicationUser() { UserName = model.Email, Email = model.Email, PersonalPage = model.PersonalPage, Gender = model.Gender, DateOfBirth = model.BirthDate};
